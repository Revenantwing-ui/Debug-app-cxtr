...
// --- REMOVED THE BROKEN RESOLUTION STRATEGY BLOCK HERE ---
...
dependencies {
    ...
    // Dexlib2 & Smali (Exclude Guava to prevent version conflict, we add it manually below)
    ...
    // Explicitly include the correct Guava version
